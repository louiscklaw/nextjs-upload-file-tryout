...
const AccountBadge = () => <Badge icon={AccountIcon}>Account & Organization</Badge>;

const APICLIBadge = () => <Badge icon={ApiIcon}>API & CLI</Badge>;

const BestPracticesBadge = () => <Badge icon={BestPracticesIcon}>Best Practices</Badge>;

const DistributionBadge = () => <Badge icon={DistributeIcon}>Testing Distribution</Badge>;
const EnterpriseStoreBadge = () => <Badge icon={EnterpriseStoreIcon}>Enterprise App Store</Badge>;
const FaqBadge = () => <Badge icon={FaqIcon}>Troubleshooting & FAQ</Badge>;

const InfrastructureBadge = () => <Badge icon={InfrastructureIcon}>Build Infrastructure</Badge>;

const IntegrationsBadge = () => <Badge icon={IntegrationsIcon}>Integrations</Badge>;
const PublishBadge = () => <Badge icon={PublishIcon}>Publish</Badge>;

const PublishIntegrationsBadge = () => <Badge icon={PublishIcon}>Publish Integrations</Badge>;
...
const SigningIdentitiesBadge = () => <Badge icon={SigningIdentitiesIcon}>Signing Identities</Badge>;

const BuildBadge = () => <Badge icon={BuildIcon}>Build</Badge>;

const BuildIntegrationsBadge = () => <Badge icon={BuildIntegrationsIcon}>Build Integrations</Badge>;
const ContinuousTestingBadge = () => <Badge icon={ContinuousTestingIcon}>Continuous Testing</Badge>;
const EnvironmentVariablesBadge = () => <Badge icon={EnvironmentVariablesIcon}>Environment Variables</Badge>;
